...
public class OkHttpConnection implements Connection {
    ...
    public static Connection connect(String url) {
        Connection con = new OkHttpConnection();
        con.url(url);
        return con;
    }
    ...
    public static class Request extends OkHttpConnection.Base<Connection.Request> implements Connection.Request {
    ...
    public static class Response extends OkHttpConnection.Base<Connection.Response> implements Connection.Response {
        ...
        static Response execute(Connection.Request req, Response previousResponse) throws IOException {
            ...
            try {
                ...
                if (contentType != null && xmlContentTypeRxp.matcher(contentType).matches()) {
                    ...
                    if (req instanceof OkHttpConnection.Request && !((Request) req).parserDefined) {
        ...
        private void setupFromConnection(HttpURLConnection conn, OkHttpConnection.Response previousResponse) throws IOException {
            this.conn = conn;
